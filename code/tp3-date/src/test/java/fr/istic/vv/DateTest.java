...
class DateTest {
    private static final int DAY_VALID = 5;
    private static final int DAY_VALID_NEXT = 6;
    private static final int DAY_VALID_PREVIOUS = 4;
    ...
    private static final int MONTH_INVALID_GREATER = 15;
